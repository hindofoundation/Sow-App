...
import { X, Mail, Lock, User, ArrowRight, Loader2, ShieldCheck, Facebook } from 'lucide-react';
...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, initialMode = 'login' }) => {
  ...
  const handleSocialLogin = (provider: string) => {
    setIsLoading(true);
    console.log(`Initializing ${provider} auth flow...`);
    setTimeout(() => {
      setIsLoading(false);
      onClose();
    }, 1200);
        ...
        <div className="p-8 md:p-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <button
              ...
              disabled={isLoading}
              className="flex items-center justify-center gap-3 py-3 px-4 border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors text-zinc-900 dark:text-zinc-100 font-bold text-[10px] uppercase tracking-widest"
            >
          ...
          <div className="relative mb-8 flex items-center justify-center">
            ...
            <span className="relative px-4 bg-white dark:bg-zinc-900 text-zinc-400 text-[10px] font-black uppercase tracking-[0.3em]">
              OR
            </span>
          </div>
